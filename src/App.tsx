...
export default function App() {
  ...
  return (
    <motion.div 
      ...
      className="min-h-screen bg-[#F8F8F8] text-black font-sans"
    >
      <Header
      ...
      <div className="max-w-3xl mx-auto px-4 mt-8 mb-4 md:hidden">
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="w-full bg-white border border-black/10 rounded-full py-3 pl-12 pr-10 text-sm focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] shadow-[0_2px_10px_rgba(0,0,0,0.03)] transition-all"
          />
          {searchQuery && (
            <button onClick={() => setSearchQuery('')} className="absolute right-4 text-black/40 hover:text-black transition-colors">
              <X className="w-4 h-4" />
            </button>
          )}
        </div>
